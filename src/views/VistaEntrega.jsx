...
export default function VistaEntrega({ pedido, ir, usuario }) {
  const [datos, setDatos] = useState({ 
    ...
    direccion: pedido.datosEntregaSugeridos?.direccion || '', 
    referencia: pedido.datosEntregaSugeridos?.referencia || '', 
    telefono: pedido.datosEntregaSugeridos?.telefono || usuario?.telefono || '', 
    metodoPago: pedido.datosEntregaSugeridos?.metodoPago || 'efectivo', 
    montoEfectivo: '' 
  });
